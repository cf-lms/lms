...
testServer.post('/user/repos', function(req, res) {
  res.json({msg: 'bravo', full_name:'dummy'});
});
testServer.post('/login/oauth/access_token', function(req, res) {
...
testServer.get('/repos/cf-lms/dummy/contents/example/example.md', function(req, res) {
...
testServer.post('/orgs/javascript-test/repos', function(req, res) {
